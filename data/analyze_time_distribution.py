...
# Argument parser
parser = argparse.ArgumentParser(description="Analyze Time Distribution of Papers")
parser.add_argument('--csv_path', type=str, required=True, help="Path to the papers CSV file")
